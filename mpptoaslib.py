...
def loglikelihood(Sd, data_portrait_FT, model_portrait_FT,errs_FT, P, freqs, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau,param_dict):
    # print(Sd)
    # Sd, data_portrait_FT, model_portrait_FT,errs_FT, P, freqs, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau = likelihood_args
    phi = param_dict["phi"]
    DM = param_dict["DM"]
...
def fit_portrait_full(data_port, model_port, init_params, P, freqs,
    ...
    if bayes:
        import nautilus
        import corner
        other_args_bayes = (Sd, data_port_FT, model_port_FT, errs_FT, P, freqs, nu_out_DM,
