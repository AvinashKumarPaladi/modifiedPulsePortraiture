...
def loglikelihood(Sd, params, data_portrait_FT, model_portrait_FT,errs_FT, P, freqs, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau):
    # print(Sd)
    ...
    N = len(errs_FT)
    covm=np.diag(errs_FT**2)
    # print("loglikelihood: ",-0.5*chi2_prime - 0.5*(  np.log(2*np.pi)*N + np.linalg.slogdet(covm)[0]*np.linalg.slogdet(covm)[1]))
    return -0.5*chi2_prime - 0.5*(  np.log(2*np.pi)*N + np.linalg.slogdet(covm)[0]*np.linalg.slogdet(covm)[1])
...
def loglikelihood_band35(params, Sd_band3, Sd_band5, data_portrait_FT_band3, data_portrait_FT_band5, 
                               model_portrait_FT_band3, model_portrait_FT_band5,
                               errs_FT_band3, errs_FT_band5, P, freqs_band3, freqs_band5, 
    ...
    chi2_prime_band3 = loglikelihood(Sd_band3, params_band3, data_portrait_FT_band3, model_portrait_FT_band3,
                                   errs_FT_band3, P, freqs_band3, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau)
    chi2_prime_band5 = loglikelihood(Sd_band5, params_band5, data_portrait_FT_band5, model_portrait_FT_band5,
                                   errs_FT_band5, P, freqs_band5, nu_DM, nu_GM, nu_tau, fit_flags, log10_tau)
    chi2_prime_band35 = chi2_prime_band3 + chi2_prime_band5
...
def fit_portrait_full(data_port_band3, data_port_band5, model_port_band3, model_port_band5,
                      ...
                      method='trust-ncg', is_toa=True, bayes=False, quiet=True, filename = None, pool = 10, outdir=None):
    #print(nu_fits)
...
# =============================================================================
    ...
    if bayes:
        import nautilus
        import corner
        other_args_bayes = (params, Sd_band3, Sd_band5, data_port_FT_band3, data_port_FT_band5, model_port_FT_band3, model_port_FT_band5,
